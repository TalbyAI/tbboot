...
Generated on 2026-08-11 23:29:37 +02:00.
...
| Non-fixture code files | 2 | 3 |
| Non-fixture code lines | 404 | 334 |

## Verdict

Keep the project as an integration repository for now. The proposed path passed 12/12 scenario checks with 3 setup instructions and 2/404 non-fixture code files/lines; composition coverage is not exercised (chezmoi missing) with 2 setup instructions and 3/334 code files/lines. Re-run with chezmoi before deciding to build a differentiated product.
